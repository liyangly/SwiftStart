...
///Int （signed integer 有符号的）
//在32位平台，Int与Int32的大小一致；在64位平台，Int与Int64的大小一致
///UInt （unsigned integer 无符号的）
...
//确定有值的 optionals 
let possibleString: String? = "An optional string." //possibleString 为 optionals
let forcedString: String = possibleString! // requires an exclamation mark（需要一个感叹号😂）

let assumedString: String! = "An implicitly unwrapped optional string."
let implicitString: String = assumedString // no need for an exclamation mark

var sss:String! = "ssssss"
sss = nil
//如果一个 implicitly unwrapped optional 在之后可能会变为 nil ，就不要当做 implicitly unwrapped optional 处理,
//验证是否为 nil 就用normal optional 来修饰
